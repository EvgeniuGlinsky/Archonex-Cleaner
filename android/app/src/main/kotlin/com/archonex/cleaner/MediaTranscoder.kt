...
class MediaTranscoderChannel(
    ...
    private val methods = MethodChannel(messenger, "com.archonex.cleaner/transcoder")
    private val progress = EventChannel(messenger, "com.archonex.cleaner/transcoder/progress")
